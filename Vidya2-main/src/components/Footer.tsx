      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-white">Arcane.AI</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:support@arcane.ai" className="text-gray-400 hover:text-white transition-colors">support@arcane.ai</a></li>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <div>© 2025 Arcane.AI. Making Skill India multilingual.</div>
