...
const features = [
  {
    ...
    desc: 'AI understands vocational terminology and technical jargon'
  },
  {
    title: 'Cultural adaptation',
    desc: 'Examples and references tailored to each region'
  },
  {
    title: 'Voice synthesis',
    desc: 'Text-to-speech in 22+ Indian languages'
  },
  {
    title: 'Domain glossaries',
    desc: 'Industry-specific vocabulary databases'
  },
  {
    title: 'API integration',
    desc: 'Seamless connection with LMS platforms'
  },
  {
    title: 'Continuous learning',
    desc: 'AI improves with every translation'
  }
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-2xl">
            Arcane.AI doesn't just translate words. It adapts meaning, tone, and examples for each language and region.
          </p>
        </div>
